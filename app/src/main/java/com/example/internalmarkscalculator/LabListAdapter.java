...
public class LabListAdapter extends ArrayAdapter<Laboratory>{
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        pre1.setText(Float.toString(lab.preLab[0]));
        pre2.setText(Float.toString(lab.preLab[1]));
        rep1.setText(Float.toString(lab.report[0]));
        rep2.setText(Float.toString(lab.report[1]));
        total.setText(Float.toString(lab.total));
