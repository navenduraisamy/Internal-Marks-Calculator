...
public class TheoryListAdapter extends ArrayAdapter<Theory>{
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        CA1.setText(Float.toString(theory.CA[0]));
        CA2.setText(Float.toString(theory.CA[1]));
        CA3.setText(Float.toString(theory.CA[2]));
        aggCA.setText(Float.toString(theory.aggCA));
        tut1.setText(Float.toString(theory.tut[0]));
        tut2.setText(Float.toString(theory.tut[1]));
        ap.setText(Float.toString(theory.ap));
        total.setText(Float.toString(theory.total));
